package study.cracking_the_coding_interview_6e.linked_list.problem2_5;
...
public class BookSolutionTest {
    ...
    public void case1() {
        ...
        //when
        Node<Integer> sum = BookSolution.addNodesReversedWay(node1, node2, 0);
    ...
    public void case4() {
        ...
        //when
        Node<Integer> sum = BookSolution.addNodesNormalWay(node1, node2);
