...
public class Solution {
	...
	List<Integer> friends = new ArrayList<Integer>(); //����� ģ������ ����
	List<Integer> weakPoints = new ArrayList<Integer>(); //��������� ����
	...
	private boolean canInspectAll(List<Integer> friendList, List<Integer> weakList) {
		...
		while(friendList.size() > 0) { //����� ģ���� �ִٸ�
			int friendToUse = friendList.get(0);
			friendList.remove(0);
			int idx = getUnInspectIdx(weakVisit); //������ �˻���� ���� ������ ��ȯ
			if(idx == -1) //�˻���� ���� ������ ���ٸ�
				break;
			int from = weakArray[idx];
			int to = from + friendToUse;
			inspect(weakArray, weakVisit, from, to); //from ~ to�� ���ϴ� ������ üũ����
		}
